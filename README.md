# 🍜 Nongki Yuk! - Mobile App

A Flutter-based mobile application that helps users discover and explore the best hangout spots in South Jakarta. The app provides real-time information about cafes, restaurants, and other popular places with features like crowd monitoring, reviews, and navigation.

## 📱 Features

### 🏠 Core Features
- **Place Discovery**: Browse and search for popular hangout spots in South Jakarta
- **Real-time Crowd Monitoring**: View current crowd levels with "Crowded" and "Comfy" labels
...
If you want to run the data scraping backend:
